...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Enterprise dairy farm delivering fresh, pure milk from farm to home with precision agriculture and uncompromised quality." },
      { name: "author", content: "Pure Drop Dairy Farms" },
      { property: "og:title", content: "Pure Drop Dairy Farms" },
      { property: "og:description", content: "Fresh Milk. Pure Quality. Direct from farm to home." },
      ...
      { name: "twitter:description", content: "Fresh Milk. Pure Quality. Direct from farm to home." },
      { name: "twitter:image", content: "https://puredrop.vercel.app/og-image.jpg" },
    ],
    links: [
